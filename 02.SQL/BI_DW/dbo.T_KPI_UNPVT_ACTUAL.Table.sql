...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[T_KPI_UNPVT_ACTUAL](
...
GO
ALTER TABLE [dbo].[T_KPI_UNPVT_ACTUAL] ADD  CONSTRAINT [DF_T_KPI_UNP_A_INS_DATETIME]  DEFAULT (getdate()) FOR [INS_DATETIME]
GO
ALTER TABLE [dbo].[T_KPI_UNPVT_ACTUAL] ADD  CONSTRAINT [DF_T_KPI_UNP_A_UPD_DATETIME]  DEFAULT (getdate()) FOR [UPD_DATETIME]
GO
