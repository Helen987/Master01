USE [BI_DW]
GO
/****** Object:  Table [dbo].[T_DCP_DW1_PRODUCT_DATASHEET]    Script Date: 2017/03/22 19:29:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[T_DCP_DW1_PRODUCT_DATASHEET](
 ...
 CONSTRAINT [PK_T_DCP_DW1_PRODUCT_DATASHEET] PRIMARY KEY CLUSTERED 
(
	[SALES_ORDER_PART_NO] ASC,
	[DINCUSTCD] ASC,
	[SIP_KBN] ASC,
	[SELECT_KBN] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [BI_DW_Staging]
) ON [BI_DW_Staging]

GO
ALTER TABLE [dbo].[T_DCP_DW1_PRODUCT_DATASHEET] ADD  CONSTRAINT [DF_T_DCP_DW1_PRODUCT_DATASHEET_INSERT_TIME]  DEFAULT (getdate()) FOR [INSERT_TIME]
GO
ALTER TABLE [dbo].[T_DCP_DW1_PRODUCT_DATASHEET] ADD  CONSTRAINT [DF_T_DCP_DW1_PRODUCT_DATASHEET_UPDATE_TIME]  DEFAULT (getdate()) FOR [UPDATE_TIME]
GO
