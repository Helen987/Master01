...
GO
CREATE TABLE [dbo].[T_NS_GO_MAveCst_BL](
	...
	[MOVE_AVE_PRICE] [numeric](15, 4) NULL,
	[MOVE_AVE_PRICE_UNIT] [numeric](15, 4) NULL,
 CONSTRAINT [PK_T_NS_GO_MAveCst_BL] PRIMARY KEY CLUSTERED 
(
	[BILLDOC_NO] ASC,
	[BILLDOC_ITEM_NO] ASC
