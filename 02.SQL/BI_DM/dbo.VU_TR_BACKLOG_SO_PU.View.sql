...
--CREATE VIEW [dbo].[VU_TR_BACKLOG_SO_PU] AS SELECT * FROM [DM_SALES].dbo.VUSR_T_SO_BKLG_LATESTMASTER;

CREATE VIEW [dbo].[VU_TR_BACKLOG_SO_PU] AS SELECT [REGISTRATION_MONTH]
      ,[SALES_ORDER_NO]
      ,[SALES_ORDER_LINE_NO]
      ,[SALES_ORDER_TYPE]
      ...
      ,[SO_BKLG_AMT_USD]
      ,[SO_BKLG_AMT_EUR]
      ,[SO_BKLG_STDCST_AMT_JPY]
      ,[SO_BKLG_STDCST_AMT_USD]
      ,[SO_BKLG_STDCST_AMT_EUR]
      ,[UNIT_PRICE_JPY]
      ,[WBS_NO]
      ...
      ,[FREE_ITEM_02]
      ,[CUBE_LINK_FLG]
FROM [DM_SALES].dbo.VUSR_T_SO_BKLG_LATESTMASTER;
