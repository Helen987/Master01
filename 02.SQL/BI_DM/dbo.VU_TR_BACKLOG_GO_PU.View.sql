...
--CREATE VIEW [dbo].[VU_TR_BACKLOG_GO_PU] AS SELECT * FROM [DM_SALES].dbo.VUSR_T_GO_BKLG_LATESTMASTER;

CREATE VIEW [dbo].[VU_TR_BACKLOG_GO_PU] AS SELECT [REGISTRATION_MONTH]
      ,[SALES_ORDER_NO]
      ,[SALES_ORDER_LINE_NO]
      ,[SALES_ORDER_TYPE]
      ...
      ,[GO_BOOK_AMT_EUR]
      ,[GO Booking ANP Amt]
      ,[GO Booking ANP JPY Amt]
      ,[GO Booking ANP USD Amt]
      ,[GO Booking ANP EUR Amt]
      ,[GO_BKLG_QTY]
      ,[GO_BKLG_AMT]
      ,[GO_BKLG_AMT_JPY]
      ,[GO_BKLG_AMT_USD]
      ,[GO_BKLG_AMT_EUR]
      ,[GO_BKLG_STDCST_AMT_JPY]
      ,[GO_BKLG_STDCST_AMT_USD]
      ,[GO_BKLG_STDCST_AMT_EUR]
      ,[GO Backlog ANP Amt]
      ,[GO Backlog ANP JPY Amt]
      ,[GO Backlog ANP USD Amt]
      ,[GO Backlog ANP EUR Amt]
      ,[UNIT_PRICE_JPY]
      ,[WBS_NO]
      ...
      ,[FREE_ITEM_02]
      ,[CUBE_LINK_FLG]
FROM [DM_SALES].dbo.VUSR_T_GO_BKLG_LATESTMASTER;
