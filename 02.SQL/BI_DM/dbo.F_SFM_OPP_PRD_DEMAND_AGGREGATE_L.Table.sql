...
GO
CREATE TABLE [dbo].[F_SFM_OPP_PRD_DEMAND_AGGREGATE_L](
	...
	[OPPORTUNITY_SEQ_COUNT] [nvarchar](10) NULL,
	[UNIQUE_OPPORTUNITY_SEQ] [nvarchar](13) NULL,
	[CRM_DISP_UPDATE_DATE] [varchar](6) NULL,
	[CRM_UPDATE_DATE] [date] NULL,
	[CRM_CURRENCY_TYPE] [nvarchar](14) NULL,
	[CRM_TARGETNOMINATIONDATE] [date] NULL,
	[CRM_TARGETAWARDDATE] [date] NULL,
	[CRM_APPROVALDATE] [datetime] NULL,
	[CRM_MPSTART] [date] NULL,
	[CRM_CALENDAR_YM] [date] NULL,
	[CRM_OPPORTUNITY_NO] [varchar](7) NULL,
	[CRM_UNIQUEOPPORTUNITY_SEQ] [varchar](13) NULL,
	[CRM_FULFILLSCMCUSTOMERCODE] [nvarchar](20) NULL,
	[CRM_SALES_ORDER_PN_FOR_MTF] [nvarchar](18) NULL,
