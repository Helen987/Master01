...
CREATE VIEW [dbo].[VF_SFM_OPP_PRD_DEMAND_H] AS
SELECT
     T.OPPORTUNITY_SEQ
    ,T.OPPORTUNITY_NO
...
ON
  ...
  AND PRD.UPDATE_DATE = OPP.UPDATE_DATE
LEFT OUTER JOIN
  [BI_DW].[dbo].[R_SFM_BCCV_ACCOUNT_VIEW] ACCOUNT
ON
  OPP.ACCOUNT_GROUP_CODE = ACCOUNT.ACCOUNT_GROUP_CODE
