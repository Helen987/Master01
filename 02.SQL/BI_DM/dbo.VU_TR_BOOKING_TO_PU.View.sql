...
--CREATE VIEW [dbo].[VU_TR_BOOKING_TO_PU] AS SELECT * FROM [DM_SALES].dbo.VUSR_T_TO_BOOK_LATESTMASTER;
CREATE VIEW [dbo].[VU_TR_BOOKING_TO_PU] AS SELECT [REGISTRATION_MONTH]
      ,[SALES_ORDER_NO]
      ,[SALES_ORDER_LINE_NO]
      ,[SALES_ORDER_TYPE]
      ...
      ,[TO_BOOK_AMT]
      ,[STDCST]
      ,[TO_BOOK_STDCST_AMT_JPY]
      ,[TO_BOOK_STDCST_AMT_USD]
      ,[TO_BOOK_STDCST_AMT_EUR]
      ,[UNIT_PRICE_JPY]
      ,[UNIT_PRICE_USD]
      ,[UNIT_PRICE_EUR]
      ,[TO_BOOK_AMT_JPY]
