...
--CREATE VIEW [dbo].[VU_TR_BOOKING_SO_PU] AS SELECT * FROM [DM_SALES].dbo.VUSR_T_SO_BOOK_LATESTMASTER;
CREATE VIEW [dbo].[VU_TR_BOOKING_SO_PU] AS SELECT [REGISTRATION_MONTH]
      ,[SALES_ORDER_NO]
      ,[SALES_ORDER_LINE_NO]
      ,[SALES_ORDER_TYPE]
      ...
      ,[SO_BOOK_QTY]
      ,[SO_BOOK_AMT]
      ,[SO_BOOK_STDCST_AMT_JPY]
      ,[SO_BOOK_STDCST_AMT_USD]
      ,[SO_BOOK_STDCST_AMT_EUR]
      ,[UNIT_PRICE_JPY]
      ,[SO_BOOK_AMT_JPY]
      ,[SO_BOOK_AMT_USD]
      ,[SO_BOOK_AMT_EUR]
      ...
      ,[FREE_ITEM_02]
      ,[CUBE_LINK_FLG]
FROM [DM_SALES].dbo.VUSR_T_SO_BOOK_LATESTMASTER;
