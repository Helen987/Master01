...
--CREATE VIEW [dbo].[VU_TR_BOOKING_GO_PU] AS SELECT * FROM [DM_SALES].dbo.VUSR_T_GO_BOOK_LATESTMASTER;
CREATE VIEW [dbo].[VU_TR_BOOKING_GO_PU] AS SELECT [REGISTRATION_MONTH]
      ,[SALES_ORDER_NO]
      ,[SALES_ORDER_LINE_NO]
      ,[SALES_ORDER_TYPE]
      ...
      ,[GO_BOOK_QTY]
      ,[GO_BOOK_AMT]
      ,[GO_BOOK_STDCST_AMT_JPY]
      ,[GO_BOOK_STDCST_AMT_USD]
      ,[GO_BOOK_STDCST_AMT_EUR]
      ,[UNIT_PRICE_JPY]
      ,[GO_BOOK_AMT_JPY]
      ,[GO_BOOK_AMT_USD]
      ,[GO_BOOK_AMT_EUR]
      ...
      ,[FREE_ITEM_02]
      ,[CUBE_LINK_FLG]
FROM [DM_SALES].dbo.VUSR_T_GO_BOOK_LATESTMASTER;
