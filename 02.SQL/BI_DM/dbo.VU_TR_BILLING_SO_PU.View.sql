...
--CREATE VIEW [dbo].[VU_TR_BILLING_SO_PU] AS SELECT * FROM [DM_SALES].dbo.VUSR_T_SO_BILL_LATESTMASTER;
CREATE VIEW [dbo].[VU_TR_BILLING_SO_PU] AS SELECT [REGISTRATION_MONTH]
      ,[SALES_ORDER_NO]
      ,[SALES_ORDER_LINE_NO]
      ,[SALES_ORDER_TYPE]
      ...
      ,[SO_BILL_AMT_USD]
      ,[SO_BILL_AMT_EUR]
      ,[SO_BILL_STDCST_AMT_JPY]
      ,[SO_BILL_STDCST_AMT_USD]
      ,[SO_BILL_STDCST_AMT_EUR]
      ,[UNIT_PRICE_JPY]
      ,[SO_BILL_AMT_TTM]
      ,[SO_BILL_AMT_TP1]
      ,[SO_BILL_AMT_TP2]
      ,[SO_BILL_AMT_STD_USER]
      ,[SO_BILL_AMT_SRP]
      ,[WBS_NO]
      ...
      ,[FREE_ITEM_02]
      ,[CUBE_LINK_FLG]
FROM [DM_SALES].dbo.VUSR_T_SO_BILL_LATESTMASTER;
