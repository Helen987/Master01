...
GO
CREATE TABLE [dbo].[F_DCP_KPI_QVW](
 ...
 CONSTRAINT [PK_F_DCP_QVW] PRIMARY KEY CLUSTERED 
(
	[WBS] ASC,
	[DELIBERATION_CD] ASC,
	[CALENDAR_YM] ASC,
...
GO
ALTER TABLE [dbo].[F_DCP_KPI_QVW] ADD  CONSTRAINT [DF__F_DCP_KPI__REG_D__4AA30C57]  DEFAULT (getdate()) FOR [REG_DATETIME]
GO
ALTER TABLE [dbo].[F_DCP_KPI_QVW] ADD  CONSTRAINT [DF__F_DCP_KPI__UPD_D__4B973090]  DEFAULT (getdate()) FOR [UPD_DATETIME]
GO
