...
GO
CREATE TABLE [dbo].[F_RBW_MTF_L_EXCH_MLR](
	...
	[QTY_INC_DUP] [numeric](18, 4) NULL,
	[MTF_INC_DUP_AMT] [numeric](18, 4) NULL,
	[MTF_INC_DUP_AMT_MLR] [numeric](18, 4) NULL,
	[MTF_RATE_FLG] [nvarchar](5) NULL,
	[MTF_INC_DUP_STDCST_AMT] [numeric](18, 4) NULL,
	[MTF_INC_DUP_STDCST_AMT_MLR] [numeric](18, 4) NULL,
	[FIX_FLG] [bit] NULL
...
GO
ALTER TABLE [dbo].[F_RBW_MTF_L_EXCH_MLR] ADD  DEFAULT (newid()) FOR [ID]
GO
